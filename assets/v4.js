...
const FOOTNOTES = {
  ...
  22: '한국전력공사 전력데이터 개방포털(bigdata.kepco.co.kr), 『배전선로 접속가능용량(분산전원 접속 여유)』 — dispersedGeneration API, 동 단위 합산·변전소/주변압기 상한 절삭 반영 (v1 자산, 2025-07 수집).<span class="fn-note">용도: 산단 연계 탭의 계통 여유 레이어 — 표시 참고용이며 정본 판정에 불사용. 커버 범위는 v1 구축 구간(651개 동)에 한정.</span>',
  23: '산업단지 통합 DB 및 한전 산업분류별 전력사용량(2023–2025) 기반 주요 산업단지 좌표·참고 수요 환산 — 경기·인천·충남권 54곳 (v1 자산).<span class="fn-note">용도: 산단 연계 탭의 산업단지 포인트 레이어 — 표시 참고용이며 정본 판정에 불사용. 전남·제주권 산단은 미수록.</span>',
