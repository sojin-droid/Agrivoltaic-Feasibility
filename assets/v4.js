...
const FOOTNOTES = {
  ...
  12: '본 연구 정본 데이터베이스(agrivoltaic_ledger_v1)와 도구(agv) — 원장·판정(elig_v2)·구역 태그(agpromo_tag)·간척 태그(reclaim_tag)·배제 사유(exclusion_reason)·연접·시나리오 테이블. 회귀 검사 전량 통과 상태의 산출 (4판 세대, 2026-08-31 생성 — 세대 표식은 푸터·계보 표).<span class="fn-note">용도: 이 사이트 모든 수치의 직접 출처 — 페이지는 이 DB의 export만 렌더함.<br>자산별 구축 시점·원천 전량은 자료·한계 탭의 계보 표.</span>',
